 ...
 * 1M の VR_BOX のために DISKSEGMENT_START を 0x80700000 に変更
 *
 * Revision 2.2  1999-03-25 17:58:39+09  hayakawa
 * パラメータのセグメントをDYNAMIC_SEGMENTからPARAMETER_SEGMENTに変更
 * DYNAMIC_SEGMENTを2から14に変更
 *
...
#define PARAMETER_SEGMENT		2 /* 旧DYNAMIC_SEGMENT */
